...
// template<>
// Source<MapTempTest::t_int>::Source(std::size_t n): type("int") {
// 	for (std::size_t i = 0; i < n; ++i) {
// 		MapTempTest::t_pair_int	pair(i, 'a' + i % 26);
// 		data.insert(pair);
// 	}
// }

// template<>
// Source<MapTempTest::t_str>::Source(std::size_t n): type("string") {
// 	static std::string	strings[10] = { "hello", "how", "are", "you", "doing", "today", "?", "I", "feel", "great!" };
// 	srand(time(NULL));
// 	for (std::size_t i = 0; i < n; ++i) {
// 		MapTempTest::t_pair_str	pair(strings[i % 10], 'a' + i % 26);
// 		data.insert(pair);
// 	}
// }

// template<>
// Source<MapTempTest::t_dummy>::Source(std::size_t n): type("dummy class") {
// 	for (std::size_t i = 0; i < n; ++i) {
// 		dummy_type	d(i);
// 		MapTempTest::t_pair_dummy	pair(d, 'a' + i % 26);
// 		data.insert(pair);
// 	}
// }

// template<>
// Source<MapTempTest::t_dummy_2D>::Source(std::size_t n): type("2D dummy class") {
// 	for (std::size_t i = 0; i < n; ++i) {
// 		dummy_type	d(i);
// 		dummy_type_2D d_2D(d);
// 		MapTempTest::t_pair_dummy_2D	pair(d_2D, 'a' + i % 26);
// 		data.insert(pair);
// 	}
// }

// MapTempTest::MapTempTest(): ContainerTest("map") {}
...
// void	MapTempTest::testPerTypeConstructor(const Source< ft::map<Key, T> >& src) {
...
// void	MapTempTest::testConstructor() {
...
// template<class Key, class T>
// void	MapTempTest::testPerTypeIterator(const Source< ft::map<Key, T> >& src) {
// 	typedef	ft::map<Key, T>	t_map;
// 	logTitleSection(src.type);
...
// template<class Key, class T>
// void	MapTempTest::testPerTypeCapacity(const Source< ft::map<Key, T> >& src) {
// 	typedef	ft::map<Key, T>	t_map;
// 	logTitleSection(src.type);
...
// /*********************************************/
// template<class Key, class T>
// void	MapTempTest::testPerTypeElementAccess(const Source< ft::map<Key, T> >& src) {
// 	typedef	ft::map<Key, T>	t_map;
...
// void	MapTempTest::testElementAccess() {
...
// template<class Key, class T>
// void	MapTempTest::testPerTypeModifiers(const Source< ft::map<Key, T> >& src) {
// 	typedef	ft::map<Key, T>	t_map;
...
// void	MapTempTest::testModifiers() {
...
// template<class Key, class T>
// void	MapTempTest::testPerTypeOperator(const Source< ft::map<Key, T> >& src) {
// 	typedef	ft::map<Key, T>	t_map;
// 	typedef	typename t_map::iterator iterator;
// 	typedef	typename t_map::const_iterator const_iterator;
// 	logTitleSection(src.type);
...
// void	MapTempTest::testAllocator() {
// 	int psize;
// 	t_int		map;
// 	t_pair_int* p;
