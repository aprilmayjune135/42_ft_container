...
// 	#include <map>
// #else
// 	#include "../container/map_temp.hpp"
...
// class MapTempTest: public ContainerTest {
// 	public:
...
// 		void	testPerTypeConstructor(const Source< ft::map<Key, T> >& src);

// 		template<class Key, class T>
// 		void	testPerTypeIterator(const Source< ft::map<Key, T> >& src);
...
// 		template<class Key, class T>
// 		void	testPerTypeOperator(const Source< ft::map<Key, T> >& src);
